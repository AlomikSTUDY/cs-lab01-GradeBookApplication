...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            {
                Console.WriteLine("Invalid value for weighted parameter. Please enter 'true' or 'false'.");
                return;
            }
            ...
            {
                Console.WriteLine("Invalid gradebook type. Available types: 'standard', 'ranked'.");
                return;
            }
